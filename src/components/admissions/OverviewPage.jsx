...
const AdmissionsOverview = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const overviewRes = await fetchGraphQL(`
        ...
        const programsRes = await fetchGraphQL(`
          query {
        ...
        const stepsRes = await fetchGraphQL(`
          query {
        ...
        const datesRes = await fetchGraphQL(`
          query {
        ...
        const prospectusRes = await fetchGraphQL(`
          query {
        ...
        const feeDocsRes = await fetchGraphQL(`
          query {
