...
const PlacementSection = () => {
  ...
  return (
    <section className="py-24 px-12 md:px-24 bg-[#f8f9fa]">
      ...
      {/* HEADER */}
      <h2 className="text-4xl font-bold text-[#001c40] mb-12 text-center">
        Placements
      </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-24">
        ...
        <div className="bg-[#001c40] p-8 rounded-2xl text-white text-center">
        ...
        <div className="bg-yellow-200 p-8 rounded-2xl text-[#001c40] text-center">
        ...
        <div className="bg-gray-100 p-8 rounded-2xl text-center">
          <h4 className="text-3xl font-bold text-[#001c40] mb-1">6.5 LPA</h4>
        ...
        <div className="bg-gray-100 p-8 rounded-2xl text-center">
          <h4 className="text-3xl font-bold text-[#001c40] mb-1">120+</h4>
          <p className="text-[10px] uppercase font-bold text-gray-400">
            Recruiters
          </p>
        </div>
      ...
      {/* ================= STUDENT HIGHLIGHTS ================= */}
      <h3 className="text-2xl font-bold text-[#001c40] mb-12 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {students.slice(0, 3).map((s, index) => (
          ...
          >
            ...
            {/* TEXT */}
            <div>
              <h5 className="font-bold text-[#001c40]">
                {s.name}
              </h5>
